...
pathBaseSpaceSampleOrganisation = os.path.join(args.pathScript, "Step0_SampleReorganisation","BaseSpaceSampleOrganisation.py" )
command = ["python3", pathBaseSpaceSampleOrganisation, args.pathRawFiles]
