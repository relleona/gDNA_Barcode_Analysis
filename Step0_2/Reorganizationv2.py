...
from Reorganizationfunction import process_excel_files, extract_primer_data, \
    ...
    sanitize_dirname, modify_config, group_samples, find_common_prefix, get_sample_name, combine_fastq_files
...
def main(input_path, output_path, stagger_file_path, script_path):
    ...
    for main_folder_path, sample_id_list in main_folders.items():
        ...
        create_stagger_file(os.path.basename(main_folder_path), output_path)
        ...
        if os.path.exists(destinationfile):
            print(f"Config file created: {destinationfile}")
        else:
